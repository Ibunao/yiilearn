...
class QueryBuilder extends \yii\base\Object
{
     ...
     * @param array $params the binding parameters to be populated  占位符数组
     * @param bool $distinct 是否去重
     * @param string $selectOption 查新模式，没用过
